...
#
# The map has no basemap tiles (deliberately - it avoids both the cost and the
# usage restrictions of third-party tile services), so the only geographic
# context it carries is the shape of the local authority polygons
...
print('Step 07: Export place labels')
